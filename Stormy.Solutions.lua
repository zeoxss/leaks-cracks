...
function library:New(name)
	...
	local Stormy = Instance.new("ScreenGui")
	...
	Stormy.Name = "Stormy.solutions"
	Stormy.ResetOnSpawn = false
	Stormy.ZIndexBehavior = "Global"
	Stormy.DisplayOrder = 420133769

	local UIScale = Instance.new("UIScale")
	UIScale.Parent = Stormy
	...
	game:GetService("UserInputService").InputBegan:Connect(function(key)
		if key.KeyCode == Enum.KeyCode.Insert then
			Stormy.Enabled = not Stormy.Enabled
			library.uiopen = Stormy.Enabled
		end
	end)
...
makefolder("stormylua")

local allluas = {}

for _,lua in pairs(listfiles("stormylua")) do
	local luaname = string.gsub(lua, "stormylua\\", "")
...
luascripts:Element("Button", "load", {}, function()
	loadstring(readfile("stormylua\\"..values.luas["lua scripts"].lua.Scroll))()
end)
